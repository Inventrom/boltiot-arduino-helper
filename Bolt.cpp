...
Bolt bolt;
void Bolt::Begin(HardwareSerial& uart){
    this->communication_port=&uart;
    uart.begin(9600);
}

void Bolt::Begin(int Rx_Pin,int Tx_Pin){
...
void Bolt::CheckPoll(float a,float b,float c,float d,float e,float f){
    int length;
